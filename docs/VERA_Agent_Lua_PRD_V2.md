# VERA Agent on Lua — PRD V2 (Hackathon-Optimized)

## 1. Document Purpose
This PRD V2 refines the original VERA Lua hackathon plan to maximize scoring on:
- code quality
- usefulness
- market opportunity
- architecture
...
## 2. Product Summary
VERA Agent is a conversational AML investigation agent built with lua-cli and TypeScript. It analyzes transaction datasets, identifies suspicious Nigerian laundering patterns, produces confidence-weighted findings, and drafts NFIU-oriented STR reports for human review.
...
- No modification of vera-frontend/.
