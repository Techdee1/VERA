...
This file stores the Lua documentation excerpt shared by the team for local reference during VERA agent implementation.
...
## Operational notes for VERA agent work
