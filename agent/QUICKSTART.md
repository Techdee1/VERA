...
This guide is for validating VERA quickly in sandbox and production.
...
npx lua chat --env production -t vera-smoke-1 -m "Analyze these transactions and return a structured summary. Data:\n$CSV_DATA"
npx lua chat --env production -t vera-smoke-1 -m "I explicitly want you to generate the STR report now."
```
