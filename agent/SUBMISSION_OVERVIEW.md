# VERA Submission Overview

## 1. What This Agent Does

VERA is an AML investigation agent built on Lua AI. It ingests transaction data, models entity flows as a graph, detects suspicious patterns, produces explainable risk scores, and generates Suspicious Transaction Report drafts for compliance teams. It is upgraded from the original GRACE agent.
